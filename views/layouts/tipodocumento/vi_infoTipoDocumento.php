    ...
    <div class="admin-contenedor">
        ...
        <div class="admin-menu">
            ...
            <div class="admin-contenido">
                <form name="frmGuardar" id="frmGuardar" class="row g-3 needs-validation was-validated">
                    <div class="col-12 col-md-12">
                        <label for="nombre" class="form-label">Nombre Tipo Documento *</label>
                        <input type="text" name="nombre" id="nombre" value="<?= $nombre ?>" class="form-control" required>
                    </div>
                    <!--Este select deberia ir hidden o desde base de datos definirse por defecto que cada registro nuevo se guarde con estado="a" en categoria-->
                    ...
                    <input type="hidden" name="id" id="id" value="<?= $idTipoDocumento ?>">
...
<script language="javascript">
    $(document).ready(function() {
        ...
        $("#frmGuardar").bind("submit", function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?= BASE_SERVER ?>ws/TipoDocumento/updateOne',
                data: $(this).serialize(),
                beforeSend: function() {
