            ...
            <div class="admin-contenido">
                ...
                <div class="row">
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <a href="<?= BASE_URL . 'Dashboard/crearTipoDocumento'; ?>" class="btn btn btn-dark my-2"><i class="bi bi-plus-circle"></i> Añadir Tipo de Documento</a>
                    </div>
                </div>
