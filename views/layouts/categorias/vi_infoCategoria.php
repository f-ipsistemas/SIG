        ...
        <div class="admin-menu">
            ...
            <div class="admin-contenido">
                <form name="frmGuardar" id="frmGuardar" class="row g-3 needs-validation was-validated">
                    ...
                    <input type="hidden" name="action" id="action" value="updateCategoria">
                    <input type="hidden" name="id" id="id" value="<?= $idCategoria ?>">
...
<script language="javascript">
    $(document).ready(function() {
        ...
        $("#frmGuardar").bind("submit", function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?= BASE_SERVER ?>ws/AreaCategoria/updateOne',
                data: $(this).serialize(),
                beforeSend: function() {
